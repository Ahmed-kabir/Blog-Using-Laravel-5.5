                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/add_user')}}">Add user</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/manage_user')}}">Manage user</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/add/category')}}">Add Cetegory</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/add_manufecture')}}">Add Manufecture</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/manageManufecture')}}">Manage Manufecture</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/addProduct')}}">Add Product</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/manageProduct')}}">Manage Product</a>
                                </li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/add/tag')}}">Add Tag</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/manage/tag')}}">Manage Tag</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::to('/add/blog')}}">Add Blog</a>
                                </li>
                                <li>
                                    <a href="{{URL::to('/manage/blog')}}">Manage Blog</a>
                                </li>
                            </ul>
