<div id="extra-wrap"><div id="extra" class="clearfix">
                ...
                <div id="gallery" class="clearfix">
                    ...
                    <p class="thumbs">
                        <a href="index.html"><img src="{{asset('kabir/images/thumb.png')}}" width="42" height="43" alt="thumbnail" /></a>
                        <a href="index.html"><img src="{{asset('kabir/images/thumb.png')}}" width="42" height="43" alt="thumbnail" /></a>
                        <a href="index.html"><img src="{{asset('kabir/images/thumb.png')}}" width="42" height="43" alt="thumbnail" /></a>
                        <a href="index.html"><img src="{{asset('kabir/images/thumb.png')}}" width="42" height="43" alt="thumbnail" /></a>
                        <a href="index.html"><img src="{{asset('kabir/images/thumb.png')}}" width="42" height="43" alt="thumbnail" /></a>
                ...
                <div class="col first">
                    ...
                    <ul class="subscribe-stuff">
                        <li><a title="RSS" href="index.html" rel="nofollow">
                                <img alt="RSS" title="RSS" src="{{asset('kabir/images/social_rss.png')}}" /></a>
                        </li>
                        <li><a title="Facebook" href="index.html" rel="nofollow">
                                <img alt="Facebook" title="Facebook" src="{{asset('kabir/images/social_facebook.png')}}" /></a>
                        </li>
                        <li><a title="Twitter" href="index.html" rel="nofollow">
                                <img alt="Twitter" title="Twitter" src="{{asset('kabir/images/social_twitter.png')}}" /></a>
                        </li>
                        <li><a title="E-mail this story to a friend!" href="index.html" rel="nofollow">
                                <img alt="E-mail this story to a friend!" title="E-mail this story to a friend!" src="{{asset('kabir/images/social_email.png')}}" /></a>
                        </li>
                    </ul>
